...
namespace Leap.Unity {
  ...
  public class LeapHandController : MonoBehaviour {
    ...
    // chenxin Get RemoteHandServer
    [SerializeField]
    private RemoteFrameServer remoteHandServer;

    //RemoteHandServer remoteHandServer = GameObject.Find("Websocket").GetComponent<RemoteHandServer>();
